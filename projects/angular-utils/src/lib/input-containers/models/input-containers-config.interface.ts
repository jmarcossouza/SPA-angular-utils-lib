export interface InputContainersConfig {
    /**
     * @description Pra injetar alguma classe na `<div>` pai do `<input>` em `<jms-utils-input-text-container>`.
     ...
     */
    feedbackErrorsMessages?: FeedbackErrorsMessages;
    /**
...
export interface FeedbackErrorsMessages {
    /**
